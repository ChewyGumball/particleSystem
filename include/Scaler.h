...
public:
	explicit Scaler(const glm::vec2 &scale, const std::function<glm::vec2(const float&, const Particle&, const glm::vec2&)> &fader = [](const float &maxLife, const Particle &p, const glm::vec2& s){ return p.scale; })
